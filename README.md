...
|------|-------------|:----:|:-----:|:-----:|
| region | AWS Region | string | - | yes :rotating_light:	 |
...
| key_name | The key name to use for the instance | string | - | yes :rotating_light:	|
...
| aws_vpc | The vpc id | string | - | yes :rotating_light:	|
| subnet_id | Subnet ID to launch the resources in | string | - | yes :rotating_light:	|
| security_groups | List of Security Group IDs allowed to connect to the instance | list(string) | - | yes :rotating_light:	 |
...
| kms_key_id | Amazon Resource Name (ARN) of the KMS Key to use when encrypting the volume | string | - | yes :rotating_light:	|
...
| name | The name of the resource | string | - | yes :rotating_light:	|
| application_name | The name of the resource | string | - | yes :rotating_light:	|
| application_type | Application type represent the type of application (e.g monitoring, db) | string | - | yes :rotating_light:	|
| stack | Stack represent the type of environment (e.g dev, qa, stage, prod) | string | - | yes :rotating_light:	|
