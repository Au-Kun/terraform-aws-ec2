...
Add-Computer -DomainName $DN.ToUpper() -NewName $ServerName.ToUpper() -Credential (New-Object -TypeName PSCredential -ArgumentList "$domainuser", (ConvertTo-SecureString -String "$domainpw" -AsPlainText -Force)[0]) -PassThru -Restart
